<template>
    <div class="flex flex-col items-center justify-center w-screen min-h-screen bg-gray-100 text-gray-800">
        <div
            ...
            <!-- begin:: body -->
            <h1 class="text-4xl font-bold text-gray-800 px-4 pb-5">TUGAS AKHIR Aplikasi Chat dilengkapi Bot Informasi Akademik berbasis Rule pada Android menggunakan Vue.js dan Firebase</h1>
